...
You did a good job with json loading and saving and classes too.
Pay attention to testing your project better, and thinking of edge cases.
look for my comments in ###
Ran
...
def main():
    while True:
        ...
        # it was better to use enum here
        if choice == "0":
            break
        elif choice == "1":
            add_customer()
